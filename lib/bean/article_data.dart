...
class HomeListItemUI extends StatelessWidget {
            ...
            onTap: onTap??(){
              Get.toNamed(
                  ...
                  arguments: {
                    ...
                    ConstantInfo.ARTICLE_AUTHOR:articleItem.shareUser.isEmpty?articleItem.author:articleItem.shareUser,
                  });
            }));
  }
}
