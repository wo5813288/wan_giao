...
class PersonPage2 extends StatefulWidget {
  @override
  _PersonPageState createState() => _PersonPageState();
}

class _PersonPageState extends State<PersonPage2> with AutomaticKeepAliveClientMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        iconTheme: IconThemeData(color: Get.isDarkMode ? Colors.grey : Colors.black.withOpacity(0.7)),
        elevation: 0,
        backgroundColor: Theme.of(context).scaffoldBackgroundColor,
        actions: [
          IconButton(
  ...
  Widget _buildPersonTop() {
    return Container(
      padding: EdgeInsets.only(right: 10.w,bottom: 5.h,top: 5.h),
      child: Row(
