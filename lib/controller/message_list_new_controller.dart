...
class MessageListNewController extends BaseGetXControllerWithRefesh{
  var _messageItems = <Message>[].obs;
  List<Message> get messageItems => _messageItems;
  int _pageIndex = 1;
  ///获取已读消息列表
  getMessageList(bool isShowLoading, {bool refresh}){
    handleRequest(HttpManager.instance.get('message/lg/unread_list/$_pageIndex/json'), isShowLoading, (value){
